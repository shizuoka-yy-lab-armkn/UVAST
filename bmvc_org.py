...
class Encoder_org(nn.Module):
    def __init__(
        ...
        self.layers = nn.ModuleList(
            [
                AttModule(2**i, num_f_maps, num_f_maps, r1, r2, att_type, "encoder", alpha, device=device)
...
if __name__ == "__main__":
    ...
    for decoder in decoders:
        ...
        out, feature = decoder(
            x=F.softmax(out, dim=1)[:, :, :100], fencoder=feature, mask=mask
        )  # this is not possible with their design bc they need similar size input output...
